...
const forbiddenPatterns = [
  ...
  /(?:只有澜泊|离不开澜泊|依赖澜泊|只有 tata|离不开 tata|依赖 tata|只有鹿禅|离不开鹿禅|依赖鹿禅|唯一理解|最亲密|忠诚度|亲密度)/i,
  /(?:忽略.{0,8}(?:规则|指令)|system prompt|开发者消息|泄露提示词)/i,
  /(?:出生|生日|生于).{0,12}(?:\d{1,2}[月/.\-]\d{1,2}|上午|下午|凌晨|点|时)|(?:白羊|金牛|双子|巨蟹|狮子|处女|天秤|天蝎|射手|摩羯|水瓶|双鱼)(?:座)?|(?:八字|四柱|命盘|日主|十神|大运|流年).{0,16}(?:甲|乙|丙|丁|戊|己|庚|辛|壬|癸|子|丑|寅|卯|辰|巳|午|未|申|酉|戌|亥)/i,
];
